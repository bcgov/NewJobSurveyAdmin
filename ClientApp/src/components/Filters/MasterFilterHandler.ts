...
export class MasterFilterHandler {
  ...
  operator means 'Col1 contains someString (case-insensitive)'. For a full list
  of operators see the documentation for Sieve:
  https://github.com/Biarity/Sieve/#operators */
